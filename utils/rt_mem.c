...
#endif							/* CONFIG_IOTIVITY_RT_TRACE_MEMORY */
...
#endif							/* CONFIG_IOTIVITY_RT_BUDDY_MEM_SYS */
...
void print_mem_log(void)
{
	...
	while (itr) {
		...
		itr = itr->next;
#if defined(CONFIG_IOTIVITY_RT_BUDDY_MEM_SYS)
	...
	printf("===================================================================================\n");
#else
	printf("==== Please Enable CONFIG_IOTIVITY_RT_TRACE_MEMORY ====\n");
#endif
}
